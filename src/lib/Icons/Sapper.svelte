...
<svg xmlns="http://www.w3.org/2000/svg" class={className} viewBox="0 0 98.2 118">
	<path
		fill="#159497"
		d="M91.9,15.6C81-0.1,59.3-4.7,43.7,5.3L16.2,22.8C8.7,27.5,3.5,35.2,2,43.9c-1.3,7.3-0.2,14.8,3.3,21.3
	...
	<path
		fill="#ffffff"
		d="M41,103.9c-8.9,2.3-18.2-1.2-23.4-8.7c-3.2-4.4-4.4-9.9-3.5-15.3c0.2-0.9,0.4-1.7,0.6-2.6l0.5-1.6l1.4,1
